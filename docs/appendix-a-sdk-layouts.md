...
::: {.callout-note}
here are some offsets from april 2026:

[+] Attached to BL4 (PID: 31140)
[*] Finding GEngine...

[*] Scanning data sections for GEngine pointer...
  Sections to scan: .data2, .rsrc, .rdata, .data, .srdata, _RDATA
  Total: 59 MB

  Scanning .data2 (0x14e74f000, 16384KB)... (40369 tested so far)

  Scanning .rsrc (0x15136b000, 5440KB)...

  [+] FOUND GEngine: 0xb390aac0
      Location: .rsrc+0x430ec0 (0x15179bec0)
      Offset from base: 0x1179bec0
      Backpack: 102 items (verified @U)
      Tested 83635 unique pointers in 3.17s
[+] GEngine: 0xb390aac0
